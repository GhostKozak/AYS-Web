...
const DEFAULT_LAYOUT: any = {
  lg: [
    { i: "company", x: 0, y: 0, w: 3, h: 5 },
    { i: "parkingLot", x: 3, y: 0, w: 3, h: 5 },
    { i: "unloaded", x: 6, y: 0, w: 3, h: 5 },
    { i: "live", x: 9, y: 0, w: 3, h: 5 },
    { i: "weekly", x: 0, y: 5, w: 6, h: 4 },
    { i: "yearly", x: 6, y: 6, w: 6, h: 4 },
  ],
  md: [
    { i: "company", x: 0, y: 0, w: 5, h: 5 },
    { i: "parkingLot", x: 5, y: 0, w: 5, h: 5 },
    { i: "unloaded", x: 0, y: 5, w: 5, h: 5 },
    { i: "live", x: 5, y: 5, w: 5, h: 5 },
    { i: "weekly", x: 0, y: 10, w: 10, h: 4 },
    { i: "yearly", x: 0, y: 14, w: 10, h: 4 },
  ],
  sm: [
    { i: "company", x: 0, y: 0, w: 6, h: 5 },
    { i: "parkingLot", x: 0, y: 5, w: 6, h: 5 },
    { i: "unloaded", x: 0, y: 10, w: 6, h: 5 },
    { i: "live", x: 0, y: 15, w: 6, h: 5 },
    { i: "weekly", x: 0, y: 21, w: 6, h: 4 },
    { i: "yearly", x: 0, y: 25, w: 6, h: 5 },
  ],
  xs: [
    { i: "company", x: 0, y: 0, w: 4, h: 5 },
    { i: "parkingLot", x: 0, y: 5, w: 4, h: 5 },
    { i: "unloaded", x: 0, y: 10, w: 4, h: 5 },
    { i: "live", x: 0, y: 15, w: 4, h: 6 },
    { i: "weekly", x: 0, y: 21, w: 4, h: 4 },
    { i: "yearly", x: 0, y: 25, w: 4, h: 5 },
  ],
  xxs: [
    { i: "company", x: 0, y: 0, w: 2, h: 5 },
    { i: "parkingLot", x: 0, y: 5, w: 2, h: 5 },
    { i: "unloaded", x: 0, y: 10, w: 2, h: 5 },
    { i: "live", x: 0, y: 15, w: 2, h: 6 },
    { i: "weekly", x: 0, y: 21, w: 2, h: 4 },
    { i: "yearly", x: 0, y: 25, w: 2, h: 5 },
  ],
};
